...
import type { BrushType, EditorTool, EditorTransform, MapEditorState, TerrainThresholds } from './types'
...
export const editorStore = {
  ...
  isLoadMapVisible: new Signal(false),
  isNationsVisible: new Signal(false),
  isNationVisible: new Signal(false),
  isNewMapVisible: new Signal(false),
