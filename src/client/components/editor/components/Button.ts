...
export const styles = {
  button:
    'flex items-center justify-center rounded cursor-pointer transition-all duration-150 ease-in-out text-lg p-1 overflow-hidden',
  colors:
    'bg-editor-component-background border border-editor-border hover:border-editor-secondary-hover hover:bg-editor-secondary-hover',
  primary:
    'bg-editor-primary border-editor-primary text-editor-text-against-color hover:bg-editor-primary-hover hover:border-editor-primary-hover',
  secondary:
    'bg-editor-secondary border-editor-secondary text-editor-text hover:bg-editor-secondary-hover hover:border-editor-secondary-hover',
  danger:
    'bg-editor-error-background text-editor-text-against-color hover:bg-editor-error-background-hover hover:border-editor-error-background-hover',
